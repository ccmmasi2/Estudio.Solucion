        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FragranceTypeId = table.Column<int>(type: "INTEGER", nullable: false),
                    Name = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_FragranceTypes_FragranceTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FragranceTypes_Name",
                table: "FragranceTypes",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Products_BrandId_FragranceTypeId_Name_Price_Gender",
                table: "Products",
                columns: new[] { "BrandId", "FragranceTypeId", "Name", "Price", "Gender" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Products_FragranceTypeId",
                table: "Products",
